...
public class Demo extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        startStopButton = (ToggleButton) this.findViewById(R.id.StartStopButtonAP);
        ...
        Spinner sensSpinner = (Spinner) findViewById(R.id.input_sensitivity_spinnerAP);
        ...
        text = (TextView) this.findViewById(R.id.textAP);
    }
